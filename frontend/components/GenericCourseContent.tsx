...
interface GenericCourseContentProps {
  courseId: string;
}

export default function GenericCourseContent({ courseId }: GenericCourseContentProps) {
  const course = courses[courseId as keyof typeof courses];
  
  if (!course) {
    return (
      <div className="text-center py-8">
        <p className="text-red-400">Curso no encontrado</p>
      </div>
    );
  }
